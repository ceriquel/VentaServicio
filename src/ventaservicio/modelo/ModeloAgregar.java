...
public class ModeloAgregar {
    ...
    public boolean agregarVenta(String tipo_venta, String producto, int precio, int cantidad, Date fechacontra, Date fechaterm,Date fechafinc,int rut, int valorventa) throws SQLException{
        ...
        String query1="insert into VENTA (ID_VENTA, FECHA_CONTRATACION, FECHA_TERMINO_OPCIONAL, FECHA_TERMINO_CONTRATO, TIPO_VENTA_ID_TIPO, VALOR_VENTA) VALUES ("+precio+", (SELECT ID_CATEGORIA FROM CATEGORIA WHERE NOMBRE_CATEGORIA='";
